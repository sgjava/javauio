...
public class Mpu6050 implements AutoCloseable {
    ...
    // Accessors for thread-safe snapshots
    /**
     * @return Latest accelerometer values.
     */
    public double[] getAccelAccelerations() {
        return new double[]{dataSnapshot.get().accelX(), dataSnapshot.get().accelY(), dataSnapshot.get().accelZ()};
    }
    ...
    public double[] getAccelAngles() {
        return new double[]{dataSnapshot.get().accelAngleX(), dataSnapshot.get().accelAngleY(), dataSnapshot.get().accelAngleZ()};
    }
    ...
    public double[] getGyroAngularSpeeds() {
        return new double[]{dataSnapshot.get().gyroSpeedX(), dataSnapshot.get().gyroSpeedY(), dataSnapshot.get().gyroSpeedZ()};
    }
    ...
    public double[] getGyroAngles() {
        return new double[]{dataSnapshot.get().gyroAngleX(), dataSnapshot.get().gyroAngleY(), dataSnapshot.get().gyroAngleZ()};
    }
    ...
    public double[] getFilteredAngles() {
        return new double[]{dataSnapshot.get().filteredX(), dataSnapshot.get().filteredY(), dataSnapshot.get().filteredZ()};
    }
